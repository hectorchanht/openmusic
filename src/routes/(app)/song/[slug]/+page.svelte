<script lang="ts">
	...
	// quick-260926-kvz: the names store (the script lock on the visible title / artist) is likewise
	// imported lazily inside onMount.
	//
	...
	// every raw `data.artist` / `data.name` use (arriveShared, replayShared) stay untouched —
