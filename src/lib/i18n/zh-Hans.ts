...
const zhHans: Dict = {
	...
	"settings.groupHomeDesc": "排行榜、地区、板块、布局",
	...
	"settings.homeSectionRadio": "你的电台",
	...
	// --- 39: chart shelves ---
	"settings.homeSectionChartSongs": "热门歌曲",
	"settings.homeSectionNewReleases": "最新发行",
	"settings.homeSectionChartArtists": "热门歌手",
	"settings.homeSectionChartAlbums": "热门专辑",
	"settings.homeSectionYtTrending": "YouTube 热门",
	"settings.homeSectionGenres": "曲风排行榜",
	"settings.homeSrcLibrary": "你的音乐库",
	"settings.homeSrcUnavailable": "{region}暂不提供",
	"settings.homeGroupCharts": "排行榜",
	"settings.chartRegion": "排行榜地区",
	"settings.chartRegionDesc": "选择由哪个国家或地区的排行榜提供热门歌曲、最新发行、热门歌手、热门专辑和 YouTube 热门。“自动”会跟随界面语言。",
	"settings.chartRegionAuto": "自动（{region}）",
	"settings.moreRegions": "更多地区",
	"settings.moreRegionsDesc": "为你选择的每个额外地区各添加一个热门歌曲专区，按显示的顺序排列。",
	"settings.moreRegionsNone": "无",
	"settings.chartGenresDesc": "你选择的每个曲风都会在首页成为独立的排行榜专区。",
	"settings.chartGenresNone": "未选择任何曲风 — 首页不会显示曲风专区",
	"settings.homeGroupClassic": "经典（Last.fm / Deezer）",
	"settings.homeClassicDesc": "旧版本的首页专区，数据来自 Deezer 和 Last.fm。默认关闭；开启任意一项即可原样恢复。",
	"settings.homeClassicOnCount": "已开启 {n} 项",
	...
	"menu.noImport": "不再导入",
	"menu.removeDownload": "移除下载",
	"menu.removeDownloadBody": "歌曲仍留在你的音乐库中，点按后会重新在线播放。通过浏览器下载文件夹保存的文件，无法从这里处理。",
	"menu.removeDownloadDeleteFile": "同时删除本设备上的离线副本",
	"menu.removeDownloadAction": "移除",
	"tags.title": "编辑歌曲信息",
	"tags.fieldTitle": "歌曲名",
	"tags.fieldArtist": "歌手",
	"tags.fieldAlbum": "专辑",
	...
	"toast.downloadRemoved": "已移除下载。歌曲仍留在你的音乐库中。",
	...
	"home.seeAll": "查看全部",
	// --- 39: chart shelves ---
	"home.chartSongs": "{region}热门歌曲",
	"home.newReleases": "{region}最新发行",
	"home.chartArtists": "{region}热门歌手",
	"home.chartAlbums": "{region}热门专辑",
	"home.ytTrending": "{region} YouTube 热门",
	"home.genre.cantopop": "粤语流行",
	"home.genre.mandopop": "华语流行",
	"home.genre.kpop": "韩国流行",
	"home.genre.jpop": "日本流行",
	"home.genre.hiphop": "嘻哈",
	"home.genre.rock": "摇滚",
	"home.genre.dance": "舞曲",
	"home.genre.rnb": "R&B",
	"home.genre.electronic": "电子",
	"home.genre.alternative": "另类",
	"home.genre.asian": "亚洲音乐",
	"menu.options": "选项",
